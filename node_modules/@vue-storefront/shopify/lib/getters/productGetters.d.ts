...
export declare const getProductDiscountPercentage: (product: any) => number;
...
export declare const getProductFiltered: (products: any, filters?: ProductVariantFilters | any) => ProductVariant[];
export declare const getFilteredSingle: (product: any) => ProductVariant[];
...
export declare const getProductVariantId: (product: ProductVariant) => string;
export declare const getProductId: (product: ProductVariant) => string;
export declare const getProductOriginalId: (product: any) => string;
export declare const getFormattedPrice: (price: number) => string;
export declare const getProductSaleStatus: (product: ProductVariant) => boolean;
export declare const getProductCoverImage: (product: any, size?: string) => string;
export declare const getProductCollections: (product: any, field?: string) => any[];
export declare const getPDPProductCoverImage: (product: any, size?: string) => string;
export declare const getProductStockStatus: (product: ProductVariant) => boolean;
export declare const getProductStock: (product: ProductVariant) => number;
