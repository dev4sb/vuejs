...
export declare const getCartItemId: (product: any) => string;
export declare const getCartItemSlug: (product: any) => string;
...
export declare const getCartTotals: (cart: any) => AgnosticTotals;
export declare const getCartShippingPrice: (cart: Cart) => number;
export declare const getCartSubTotal: (cart: Cart) => number;
export declare const getcheckoutURL: (cart: Cart) => string;
export declare const getCartTotalItems: (cart: Cart) => number;
export declare const getCartTotalDiscount: (cart: Cart) => number;
