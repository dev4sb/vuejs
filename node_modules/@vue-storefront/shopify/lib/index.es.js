...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const getCartItemAttributes = (product, filterByAttributeName) => {
...
const getCartTotalDiscount = (cart) => {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const getProductFiltered = (products, filters = {}) => {
    if (!products) {
        return [];
    }
...
const getSelectedVariant = (product, attribs) => {
    return attribs;
};
...
const getProductCollections = (product, field = 'all') => {
    ...
    if (product.collections && Object.keys(product.collections).length > 0) {
        const collections = [];
        Object.values(product.collections).map((collection) => {
            if (field === 'all') {
                collections.push({
                    id: collection.id,
